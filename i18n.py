...
LANGUAGES = {
    "kh": {
        ...
        "info_gen_agentic": "បើក៖ ម៉ូដែលអាចប្រើ web search និងអានទំព័របណ្តាញដោយខ្លួនឯង មុននឹងឆ្លើយ (ត្រូវការម៉ូដែលមានសមត្ថភាពគ្រប់គ្រាន់ ចាប់ពី Qwen3-4B ឡើងទៅ)។ បិទ៖ ការសន្ទនាផ្ទាល់ធម្មតា គ្មានឧបករណ៍។",
        "tab_rag": "📚 វិភាគឯកសារ",
    ...
    "en": {
        ...
        "info_gen_agentic": "ON: the model can use live web search and read full webpages by itself before answering (needs a capable model — roughly Qwen3-4B or above). OFF: a plain direct conversation with no tools.",
        "tab_rag": "📚 RAG Chat",
