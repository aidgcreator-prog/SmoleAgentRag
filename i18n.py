...
LANGUAGES = {
    "kh": {
        ...
        "label_memory": "🧠 ចងចាំការសន្ទនា",
        "info_memory": "ចងចាំសារពីមុនក្នុងការសន្ទនានេះ",
    ...
    "en": {
        ...
        "label_memory": "🧠 Conversation Memory",
        "info_memory": "Remembers earlier messages in this chat",
        "info_memory_detail": "ON: remembers earlier messages in this conversation, so follow-ups can refer back to what was already said. OFF: every message is answered independently, with no memory of what came before.",
        "tab_rag": "📚 RAG Chat",
